    ...
    <div class="col-md-12">
      	<div class="box box-warning">
            <div class="box-header with-border">
              	<h3 class="box-title">Pengeluaran Add</h3>
            </div>
            <?php echo form_open('pengeluaran/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-3">
						<label for="tanggal_japo" class="control-label">Tanggal Jatuh Tempo (Isi Jika Piutang)</label>
						<div class="form-group">
							<input type="date" name="tanggal_japo" value="<?php echo $this->input->post('tanggal_japo'); ?>" class="form-control" id="tanggal_japo" />
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-3">
						<label for="jenis" class="control-label">Jenis Pengeluaran</label>
						<div class="form-group">
					...
					<div class="col-md-6">
						<label for="jenis" class="control-label">Keterangan</label>
						<div class="form-group">
